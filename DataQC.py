...
def main():
    ...
    charges_dict = {}
    with open('Qcharge.json', 'r', encoding='utf-8') as f1:
        for line in f1:
            data_list = json.loads(line)
            charges_dict[data_list["id"]] = data_list["charge"]

    with open('QCtrain.json', 'w', encoding='utf-8') as file: #可更改
        with open(labels_path, 'r', encoding='utf-8') as f:
            ...
            for line in f:
                ...
                for item in data_a:
                    if item['id'] == int(id1):
                        fact = item['fact']
                if int(id1) in charges_dict:
                    charge = charges_dict[int(id1)]
                data_b = {}
