...
# 初始化 ChatGLM3 模型和 Tokenizer
tokenizer = AutoTokenizer.from_pretrained('ChatGLM3')  # 假设是一个ChatGLM3的预训练模型
...
# 数据预处理
preprocessing = DataPreprocessing(tokenizer_name='ChatGLM3', max_len=MAX_LEN)
